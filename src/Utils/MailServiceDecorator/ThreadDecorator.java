...
public class ThreadDecorator extends MailServiceDecorator {
    private final String thread;

    public ThreadDecorator(MailService mailService, boolean safe) {
        super(mailService);
        this.thread = safe ? "Safe" : "Non-safe";
    }
    ...
    private void action(boolean on) {
        ...
        System.out.println(this.thread + " Thread " + status);
    }
}
